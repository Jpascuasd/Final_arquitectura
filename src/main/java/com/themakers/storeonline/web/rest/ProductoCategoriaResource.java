...
/**
 * REST controller for managing {@link com.themakers.storeonline.domain.ProductoCategoria}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ProductoCategoriaResource {
    ...
    public ProductoCategoriaResource(ProductoCategoriaRepository productoCategoriaRepository) {
    ...
    public ResponseEntity<ProductoCategoria> createProductoCategoria(@RequestBody ProductoCategoria productoCategoria) throws URISyntaxException {
        ...
        ProductoCategoria result = productoCategoriaRepository.save(productoCategoria);
    ...
    public ResponseEntity<ProductoCategoria> updateProductoCategoria(@RequestBody ProductoCategoria productoCategoria) throws URISyntaxException {
    ...
    public ResponseEntity<ProductoCategoria> getProductoCategoria(@PathVariable Long id) {
        ...
        Optional<ProductoCategoria> productoCategoria = productoCategoriaRepository.findById(id);
