...
import com.themakers.storeonline.repository.SucursalRepository;
...
/**
 * REST controller for managing {@link com.themakers.storeonline.domain.Sucursal}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class SucursalResource {
    ...
    public ResponseEntity<Sucursal> updateSucursal(@RequestBody Sucursal sucursal) throws URISyntaxException {
