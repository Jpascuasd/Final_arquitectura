...
describe('Stock e2e test', () => {
  ...
  it('should load Stocks', async () => {
    ...
    expect(await stockComponentsPage.getTitle()).to.eq('fleastoreApp.inventariomicroservicioStock.home.title');
  ...
  it('should load create Stock page', async () => {
    ...
    expect(await stockUpdatePage.getPageTitle()).to.eq('fleastoreApp.inventariomicroservicioStock.home.createOrEditLabel');
  ...
  it('should create and save Stocks', async () => {
    ...
    await promise.all([stockUpdatePage.setCantidadInput('5'), stockUpdatePage.productoSelectLastOption()]);
  ...
  it('should delete last Stock', async () => {
    ...
    expect(await stockDeleteDialog.getDialogTitle()).to.eq('fleastoreApp.inventariomicroservicioStock.delete.question');
