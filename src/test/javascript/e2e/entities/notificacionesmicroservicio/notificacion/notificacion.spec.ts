...
describe('Notificacion e2e test', () => {
  ...
  it('should load Notificacions', async () => {
    ...
    expect(await notificacionComponentsPage.getTitle()).to.eq('fleastoreApp.notificacionesmicroservicioNotificacion.home.title');
    await browser.wait(
  ...
  it('should load create Notificacion page', async () => {
    ...
    expect(await notificacionUpdatePage.getPageTitle()).to.eq(
      'fleastoreApp.notificacionesmicroservicioNotificacion.home.createOrEditLabel'
    );
  ...
  it('should delete last Notificacion', async () => {
    ...
    expect(await notificacionDeleteDialog.getDialogTitle()).to.eq('fleastoreApp.notificacionesmicroservicioNotificacion.delete.question');
