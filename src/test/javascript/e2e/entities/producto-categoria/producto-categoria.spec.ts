...
describe('ProductoCategoria e2e test', () => {
  ...
  it('should load ProductoCategorias', async () => {
    ...
    expect(await productoCategoriaComponentsPage.getTitle()).to.eq('fleastoreApp.productoCategoria.home.title');
    await browser.wait(
  ...
  it('should load create ProductoCategoria page', async () => {
    ...
    expect(await productoCategoriaUpdatePage.getPageTitle()).to.eq('fleastoreApp.productoCategoria.home.createOrEditLabel');
  ...
  it('should create and save ProductoCategorias', async () => {
    ...
    await promise.all([productoCategoriaUpdatePage.setNombreInput('nombre')]);
  ...
  it('should delete last ProductoCategoria', async () => {
    ...
    expect(await productoCategoriaDeleteDialog.getDialogTitle()).to.eq('fleastoreApp.productoCategoria.delete.question');
