...
describe('Sucursal e2e test', () => {
  ...
  it('should load Sucursals', async () => {
    ...
    expect(await sucursalComponentsPage.getTitle()).to.eq('fleastoreApp.sucursal.home.title');
  ...
  it('should load create Sucursal page', async () => {
    ...
    expect(await sucursalUpdatePage.getPageTitle()).to.eq('fleastoreApp.sucursal.home.createOrEditLabel');
  ...
  it('should delete last Sucursal', async () => {
    ...
    expect(await sucursalDeleteDialog.getDialogTitle()).to.eq('fleastoreApp.sucursal.delete.question');
